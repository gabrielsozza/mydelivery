...
public class WmixvideoNfeGateway implements NfeGateway {
    ...
    private NFNotaInfoTotal montarTotal(RequisicaoEmissao req) {
        ...
        ic.setValorTotalFundoCombatePobreza(BigDecimal.ZERO);
        ...
        ic.setValorTotalIPIDevolvido(BigDecimal.ZERO);
    ...
    private String montarQrCodeUrl(RequisicaoEmissao req, String chave44) {
        ...
        // NT 2015/002 v2 (formato oficial usado pela lib fincatto): campos
        // separados por pipe, mas o CSC concatenado DIRETO ao cscId (sem pipe).
        // sha1(chave|versao|tpAmb|cscId + csc)
